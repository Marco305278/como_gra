...
function updateGraphicsOptions() {
        ...
        if (cb.checked) {
            ...
            switch (cb.value) {
                case 'goal':
                    ...
                    swapHomeImg.src = 'images-old/assets/swap.svg';
                    ...
                    swapPlayerFotoNumberImg.src = 'images-old/assets/swap-arrow.svg';
                    ...
                    toggleImg.src = customPlayer ? 'images-old/assets/minus.svg' : 'images-old/assets/edit.svg';
                    ...
                    swapImg.src = 'images-old/assets/arrow.svg';
    ...
    optionDiv.innerHTML += `
        ...
        <div class="player-selection">
            ...
            <label class="customStartingXI">
                <img src="images-old/assets/edit_white.svg">
    ...
    function showCaptainSelect() {
        ...
        if (!captainDiv) {
            ...
            img.src = 'images-old/assets/arrow.svg';
...
async function generatePreviews() {
    ...
    for (const graphicName of selectedGraphics) {
        ...
        const graphicFolder = `images-old/graphics/${graphicName}`;
        ...
        for (const overlayName of availableFormats) {
            ...
            if (graphicName === 'goal') {
                ...
                if (championshipSelect.value == 'seriea') { 
                    ...
                    bgImageSrc = backgroundImages['goal'] || `images-old/graphics/goal/player/${championshipSelect.value}/${position}/${playerName}${goalfotonumber}.png`;
                } else {
                    bgImageSrc = backgroundImages['goal'] || `images-old/graphics/goal/player/${championshipSelect.value}/${position}/${playerName}.png`;
                }
            }
            ...
            for (const timeVersion of timeVersions) {
                ...
                if (style) {
                    if (graphicName === 'highlights') {
                        ...
                        if (style.homeLogo) {
                            const homeLogoSrc = homeTeamSelect.value === 'como 1907'
                                ? `images-old/badge/all/como.png`
                                : `images-old/badge/${championshipSelect.value}/${homeTeamSelect.value}.png`;
                        ...
                        if (style.awayLogo) {
                            const awayLogoSrc = awayTeamSelect.value === 'como 1907'
                                ? `images-old/badge/all/como.png`
                                : `images-old/badge/${championshipSelect.value}/${awayTeamSelect.value}.png`;
                        ...
                        if (style.championshipLogo) {
                            const championshipLogoSrc = `images-old/logos/${championshipSelect.value}-logo.png`;
                    ...
                    if (graphicName === 'livematch') {
                        ...
                        const titleImageSrc = `images-old/graphics/livematch/title/${championship}_${formatSuffix}.png`;
